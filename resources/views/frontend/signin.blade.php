...
<p><a href="{{route('user.register')}}" id="customer_register_link" class="text-center mb-3 pb-3" style="margin-left: 84px;">Don't have Create account</a></p><input type="hidden" name="return_url" value="/account" /></form></div>
